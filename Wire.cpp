...
TwoWire::TwoWire(int8_t bus_num)
    : _i2c_num(bus_num), _freq(100000), rxIndex(0), rxLength(0), rxQueued(0), txIndex(0), txLength(0), txAddress(0), txQueued(0), last_error(I2C_ERROR_OK), transmitting(0), _timeOutMillis(50), STOP(true)
{
}
...
i2c_err_t TwoWire::writeTransmission(uint16_t address, uint8_t *buff, uint16_t size, bool sendStop)
{
    ...
    if (_i2c_num == I2C_NUM_0)
    {
        ...
        Status = (this->STOP) ? I2C_I2CMasterSendStart(address, I2C_I2C_WRITE_XFER_MODE, I2CTIMEOUT) : I2C_I2CMasterSendRestart(address, I2C_I2C_WRITE_XFER_MODE, I2CTIMEOUT); //���Ͷ���������
    ...
    else
    {
        ...
        Status = (this->STOP) ? I2C_1_I2CMasterSendStart(address, I2C_I2C_WRITE_XFER_MODE, I2CTIMEOUT) : I2C_1_I2CMasterSendRestart(address, I2C_I2C_WRITE_XFER_MODE, I2CTIMEOUT);
...
i2c_err_t TwoWire::readTransmission(uint16_t address, uint8_t *buff, uint16_t size, bool sendStop, uint32_t *readCount)
{
    ...
    {
        I2C_I2CMasterClearStatus();                                                                                                                                          //���I2C״̬����
        Status = (this->STOP) ? I2C_I2CMasterSendStart(address, I2C_I2C_READ_XFER_MODE, I2CTIMEOUT) : I2C_I2CMasterSendRestart(address, I2C_I2C_READ_XFER_MODE, I2CTIMEOUT); //���Ͷ���������
